 ...
 * {@code Collections.synchronizedMap(new WeakHashMap<K, Reference<V>>())} in order to support
 * better performance when accessed concurrently. This implementation follows the same design
 * constraints as {@link ConcurrentHashMap} with the exception that {@code null} values and
 * {@code null} keys are supported.
 *
 * <p>
 * <b>NOTE:</b> The use of references means that there is no guarantee that items placed into the
 ...
 *
 * <p>
 * If not explicitly specified, this implementation will use {@linkplain SoftReference soft entry
 * references}.
 *
 * @author Phillip Webb
 * @since 3.2
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V>
  ...
  protected final class Segment extends ReentrantLock {
     ...
     * be set via {@link #setReferences} to ensure that the {@code resizeThreshold} is maintained.
     */
