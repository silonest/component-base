...
public class TestCourierFactory {
  ...
  public void testCreateWithAllParameter() {
    Courier courier = CourierFactory.create(true, "test-code", "test-cause", "test-notice", "test-content");
  ...
  public void testCreateWithStatusCauseNoticeContent() {
    Courier courier = CourierFactory.create(true, "test-cause", "test-notice", "test-content");
    String json = JsonUtils.toJson(courier);
  ...
  public void testCreateWithStatusContent() {
    Courier courier = CourierFactory.create(true, "test-content");
    String json = JsonUtils.toJson(courier);
  ...
  public void testCreateWithStatusCauseNotice() {
    Courier courier = CourierFactory.create(true, "test-cause", "test-notice");
    String json = JsonUtils.toJson(courier);
  ...
  public void testCreateWithStatus() {
    Courier courier = CourierFactory.create(true);
    String json = JsonUtils.toJson(courier);
